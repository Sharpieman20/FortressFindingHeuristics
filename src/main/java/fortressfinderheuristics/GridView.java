...
public class GridView extends JPanel implements MouseListener {
	...
	public static void viewGrid() {
		...
		content = new GridView(Settings.X_ABS_MAX-Settings.X_ABS_MIN,Settings.Z_ABS_MAX-Settings.Z_ABS_MIN,15);  // Create an object of type Grid.
	 ...
	 */
	public GridView(int rows, int columns, int preferredSquareSize) {
	...
	public void mousePressed(MouseEvent evt) {
		...
		Color c = new Color( (int)(225*Math.random()),
				(int)(225*Math.random()),(int)(225*Math.random()) );
        this.setGridColorInner(row, col, c);	
	}


    public void setGridColorInner(int row, int col, Color c) {
    ...
    public static void setGridColor(int row, int col, Color c) {
        content.setGridColorInner(row, col, c);
    }
